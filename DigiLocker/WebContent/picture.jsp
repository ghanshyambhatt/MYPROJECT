						...
						<tr>
							...
							<td>
								<a 
									...
									<img src="download.png" height="35px" /></a>
							</td>
							<td>
								<a 
									href="http://pnraashishprasad.virtusa.com:8080/DigLocker/delete?FileName=${record.fileName}&CategoryID=${record.category_ID}&PageCategory=picture">
