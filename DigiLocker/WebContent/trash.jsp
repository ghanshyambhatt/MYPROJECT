			...
			<table id="file_table" style="margin-left: 250px">
				...
				<c:forEach items="${list}" var="record">
					<tr>
						...
						<td>
							<a
								href="http://pnraashishprasad.virtusa.com:8080/DigLocker/ShowFileServlet?FileName=${record.fileName}&CategoryID=${record.category_ID}">
								<img src="image/undo.png" height="40px" /> </a>
						</td>
						<td>
							<a
								href="http://pnraashishprasad.virtusa.com:8080/DigLocker/delete?FileName=${record.fileName}&CategoryID=${record.category_ID}&PageCategory=trash">
								<img src="delete.png" height="35px" /> </a>
						</td>
					</tr>
				</c:forEach>
			</table>
